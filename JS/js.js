function carregaDicionario(){
    ...
    for (var bio in biografia){
        content.innerHTML += 
        '<div class="cartas">' + 
        '<img src="' + biografia[bio].imagem + '"/>' +
        '<details>' + 
        '<summary>' + biografia[bio].nome +
        '</summary>' +
        '<p>' + biografia[bio].descricao + '</p>'+
        '<blockquote><q>' + biografia[bio].citacao + '</blockquote></q>'
        '</details></div>'
        


        console.log((bio += " " 
        + "Nome:"+ biografia[bio].nome + " "
        + "Minibio:"+ biografia[bio].descricao + " "
        + "Citação:"+biografia[bio].citacao
